...
public class KavaDatabaseHelper extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        ...
        insertDrink(db, "Lavender_Latte", "270 ml", 25, R.drawable.lavlate_item, R.string.lav_latte);
        insertDrink(db, "Cappuccino", "300", 18, R.drawable.kava_item, R.string.capuccino);
    }
    ...
    private static void insertDrink(SQLiteDatabase db, String name, String value, int price,
                                    int imageResId, int descriptionResId) {
        ContentValues drinkValues = new ContentValues();
        drinkValues.put("NAME", name);
        drinkValues.put("VALUE", value);
